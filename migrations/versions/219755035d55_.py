...
Revision ID: 219755035d55
Revises: 6ec417b9797a
Create Date: 2023-03-01 14:10:19.740421
...
revision = '219755035d55'
down_revision = '6ec417b9797a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('cumulative_debit', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('cumulative_credit', sa.Numeric(precision=5, scale=2), nullable=True),
